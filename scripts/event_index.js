...
let Navbar = (function(){
    ...
    //Bind event register
    $linkRegister.on('click',{modalName:$modalRegisterContainer},showModal);
    $closeBtnModalLogin.on('click',{modalName:$modalRegisterContainer},closeModal);
    $modalRegisterContainer.on('click',{modalName:$modalRegisterContainer},closeModalOutside);
    $modalRegisterDialog.on('click',stopCallParent);
    //Bind event Donwload
    $linkDownload.on('click',{modalName:$modalDownloadContainer},showModal);
    $closeBtnModalDownload.on('click',{modalName:$modalDownloadContainer},closeModal);
    $modalDownloadContainer.on('click',{modalName:$modalDownloadContainer},closeModalOutside);
...
let Slideshow = (function(){ 
    ...
    //Bind event
    $btnBack.on('click',{slide:'back'},setImageSelector);
    $btnNext.on('click',{slide:'next'},setImageSelector);
